...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/07 19:57:49 by andrealbuqu       #+#    #+#             */
/*   Updated: 2024/02/07 20:51:36 by andrealbuqu      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// It will return a window instance pointer.
...
// Instead it is recommended to use the function mlx_put_image_to_window
// with a recycled image that you have cleared.
...
// Memory of images is weird. It will set the line size in your given pointer.
...
// (and yes, line size is not equal to the amount of pixels in a line).
...
// his will trigger every time you click somewhere in the given screen.
// Do mind that currently these mouse events barely work, it is therefore suggested to not use them.
...
// This will trigger every time a key is pressed in a focused window.
// Unfocused windows will not register any key events.
